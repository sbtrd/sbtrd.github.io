/* Conduct'Home v1.71 — bundle applicatif propre, sans patch injecté. */
(function (global) {
'use strict';
const modules = {
...
function OrdersView({ projects, artisans, documents }) {
    ...
    const [message, setMessage] = (0, react_1.useState)();
    const sortedProjects = (0, react_1.useMemo)(() => [...projects].sort((left, right) => naturalCollator.compare(safeText(left.clientName) || safeText(left.name), safeText(right.clientName) || safeText(right.name))), [projects]);
