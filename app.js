/* Conduct'Home v1.78 — bundle applicatif propre, choix Outlook réinitialisable. */
(function (global) {
'use strict';
const modules = {
...
function OrdersView({ projects, artisans, documents }) {
    ...
    const [message, setMessage] = (0, react_1.useState)();
    const [outlookChoiceOpen, setOutlookChoiceOpen] = (0, react_1.useState)(false);
    ...
    const openOutlookSettings = () => {
        setOutlookChoiceOpen(false);
        setMessage("Dans les paramètres Windows, recherche l’extension .eml puis choisis Outlook. Reviens ensuite ici pour créer le brouillon.");
